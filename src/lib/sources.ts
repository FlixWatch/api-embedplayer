...
export const movieSources: Source[] = [
  ...
  { name: 'VidLink', url: 'https://vidlink.pro/movie/{tmdbId}?primaryColor=ffffff&secondaryColor=6f1b1b&iconColor=b00707&icons=vid&player=default&title=true&poster=true&autoplay=false&nextbutton=true', category: 'movie' },
  { name: '2embed', url: 'https://www.2embed.cc/embed/{tmdbId}', category: 'movie'},
  { name: 'LetsEmbed', url: 'https://letsembed.cc/embed/movie/?id={tmdbId}', category: 'movie' },
  { name: 'iBomma', url: 'https://uembed.site/?id={tmdbId}&apikey=ah49d4mam2wkjuksy9o0ib', category: 'movie' }
];

export const tvSources: Source[] = [
  { name: 'VidSrc', url: 'https://vidsrc.xyz/embed/tv/{id}/{season}-{episode}', category: 'tv' },
  { name: 'VidLink', url: 'https://vidlink.pro/tv/{tmdbId}/{season}/{episode}?primaryColor=ffffff&secondaryColor=6f1b1b&iconColor=b00707&icons=vid&player=default&title=true&poster=true&autoplay=false&nextbutton=true', category: 'tv' },
  { name: '2embed', url: 'https://www.2embed.cc/embedtv/{tmdbId}&s={season}&e={episode}', category: 'tv'},
  { name: 'LetsEmbed', url: 'https://letsembed.cc/embed/tv/?id={tmdbId}/{season}/{episode}', category: 'tv' },
  { name: 'iBomma', url: 'https://uembed.site/?id={tmdbId}&season={season}&episode={episode}&apikey=ah49d4mam2wkjuksy9o0ib', category: 'tv' },
  { name: 'Hentai', url: 'https://letsembed.cc/embed/hentai/?id={tmdb_id}/{season}/{episode}', category: 'tv'}
];
